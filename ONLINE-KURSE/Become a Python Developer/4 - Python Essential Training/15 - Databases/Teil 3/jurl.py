...
from bwCGI import bwCGI #wird für CGI (=API mit CGI-Protokol, um mit Web-App zu kommunizieren)
from bwDB import bwDB #DB-API
from bwConfig import configFile #API um mit Config-Dateien zu arbeiten
import random
import os, sys

g = dict( #Globale Variablen <- hier anstelle des Namespaces für Globale Variablen
    config_file = 'db.conf',
    table_name = 'jurl'
)
